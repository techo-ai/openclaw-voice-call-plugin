...
export type CallManagerHooks = {
  ...
  /**
   * Optional runtime hook invoked once a call has reached a terminal state and
   * been finalized (record persisted, timers cleared). Receives the fully
   * populated CallRecord including transcript, endedAt and endReason.
   */
  onCallFinalized?: (call: CallRecord) => void;
};
